...
#include "tm5700_gazebo/Attach.h"
#include "tm5700_gazebo/AttachRequest.h"
#include "tm5700_gazebo/AttachResponse.h"
...
namespace gazebo
{
  ...
  bool GazeboRosLinkAttacher::attach_callback(tm5700_gazebo::Attach::Request &req,
                                              tm5700_gazebo::Attach::Response &res)
  {
  ...
  bool GazeboRosLinkAttacher::detach_callback(tm5700_gazebo::Attach::Request &req,
                                              tm5700_gazebo::Attach::Response &res){
