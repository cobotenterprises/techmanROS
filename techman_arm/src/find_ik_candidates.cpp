...
#include "techman_arm/CheckPose.h"
...
bool check_pose(techman_arm::CheckPose::Request &req, techman_arm::CheckPose::Request &res) {
...
int main(int argc, char** argv) {
   ...
   ros::ServiceServer service = n.advertiseService("/techman_arm/check_pose", check_pose);
   ROS_INFO("Ready to check pose.");
   ros::spin();
